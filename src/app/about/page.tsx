...
import { workExperience, education, technologies } from "@/data/about-data";
import { metaObject } from "@/config/site.config";
import ImgUsed from "@/components/reused/ImgUsed";
              ...
              <div className="flex items-center gap-12 flex-col md:flex-row">
                ...
                >
                  <p className="text-muted-foreground leading-relaxed sm:text-lg">
                    ...
                    songs I replay endlessly, likewise, Goth.
                  </p>
                  <p className="text-muted-foreground leading-relaxed sm:text-lg">
                    ...
                    movie series <span className="italic">Peaky Blinders</span>.
